...
import fluidMechText from '../assets/texts/skills/fluid-mechanics/Fluid_Mechanics.md';



function FluidMechanicsSkillPage() {
        ...
        <div className="collapsible-section">
          {showTextBlock ? (
            <main className="main-block nasa-pdf-block" style={{ maxWidth: "90%", position: "relative", fontFamily: "'Times New Roman', Times, serif" }}>
              ...
              <TextBlock content={fluidMechText} format="markdown" />
            </main>
          ) : (
            <div
...
export default FluidMechanicsSkillPage;
